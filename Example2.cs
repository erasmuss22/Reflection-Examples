...
namespace DataDriven
{
    public class Example2
    {
        public static void Execute() 
        {
            ...
            stopWatch.Stop();
            Console.WriteLine("Example 2 Class Instantiation Elapsed time {0} ms",stopWatch.ElapsedMilliseconds);
            ...
            stopWatch.Stop();
            Console.WriteLine("Example 2 Dynamic Instantiation Elapsed time {0} ms",stopWatch.ElapsedMilliseconds);
        }
    }
}